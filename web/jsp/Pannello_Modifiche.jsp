...
<html>
  ...
  <body>
    ...
    <form class="form-container" action="Pannello_Modifiche.jsp">
      ...
      />
      <input type="text" id="codice_volo" name="codice_volo" placeholder="Codice Volo" />
      Partenza:
    ...
    if(request.getParameter("edit_volo_confirm") != null){        
    ...
    if(request.getParameter("delete_volo_confirm") != null){        
